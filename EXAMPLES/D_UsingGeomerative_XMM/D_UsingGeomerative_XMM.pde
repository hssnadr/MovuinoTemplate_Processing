...
/*
 * To use this example you need to record 3 gestures in the Movuina application
 * Once recorded, reproduce your gestures to make this script react
*/
...
void draw() {
  ...
  curGlif = constrain(movuino.xmmGestId-1,0,2);
