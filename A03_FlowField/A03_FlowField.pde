...
/*
  * Make rotation with your Movuino or Smartphone (Streamo) to generate particles
  * The more you move the more you display the text
*/
...
void setup() {
  ...
  pg.text("KNR", pg.width/2, pg.height/2);
  pg.endDraw();
...
void draw() {
  ...
  globalEnergy *= 5; // gain multiplier
  particleDensity = round(random(2) + 10*globalEnergy);  
